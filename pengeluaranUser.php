...
<head>
    ...
    <title>SisaUang - Pengeluaran</title>
...
<body>
    <div class="header">
        <img src="img/icondashboard.png" width="25px" height="25px" class="float-left logo-fav">
        <h3 class="text-secondary font-weight-bold float-left logo">Sisa</h3>
        <h3 class="text-secondary float-left logo2">Uang</h3>
