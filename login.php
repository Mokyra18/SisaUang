...
<head>
  ...
  <link rel="shortcut icon" href="img/iconlogin.png">
  <title>Login | SisaUang</title>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan SisaUang</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Login untuk gunakan SisaUang</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
