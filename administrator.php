...
<head>
    ...
    <link rel="shortcut icon" href="img/iconadmin.png">
    <title>SisaUang Admin Site</title>
...
<body>
    ...
    <div class="content">
        <div class="isi mx-auto ">
            ...
            <a class="submit" href="logout" style="display: block; margin: 0 auto; text-decoration: none;"><i class="fas fa-sign-out-alt"></i>LOGOUT</a>
        </div>
    </div>
